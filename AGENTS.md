...
- Die beiden zweisprachigen Lernfassungen werden beim Buchbau automatisch aus den absatzgleichen Dateien in `modern-german-chapters/` und `source-chapters/` erzeugt: einmal Deutsch vor Englisch und einmal Englisch vor Deutsch. Keine separaten zweisprachigen Kapiteldateien pflegen.
