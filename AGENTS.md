...
- Jede Ausgabe enthält vor dem Roman eine spoilerarme historische Einführung. `frontmatter/easy-german-introduction.md` und `frontmatter/easy-english-introduction.md` bleiben kurz und zugänglich. Die übrigen Ausgaben verwenden die ausführlicheren Texte `frontmatter/before-you-read-de.md` und `frontmatter/before-you-read-en.md`; in den zweisprachigen Ausgaben werden die entsprechenden Überschriften und Absätze beider Texte unmittelbar gepaart und in derselben Sprachreihenfolge wie der Roman gesetzt.
