...
## Modern German, Easy German, Easy English, and bilingual editions / Modernes Deutsch, Einfaches Deutsch, Einfaches Englisch und zweisprachige Ausgaben

**English:** Direct new translations of Jane Austen’s *Pride and Prejudice*
into modern German and accessible Easy German, plus a complete Easy English
adaptation and fully bilingual editions for English- and German-speaking
readers and language learners. The source text is based on the supplied
Project Gutenberg EPUB edition.

**Deutsch:** Direkte Neuübersetzungen von Jane Austens *Pride and Prejudice*
in modernes Deutsch und zugängliches Einfaches Deutsch. Hinzu kommen eine
vollständige Bearbeitung in Einfachem Englisch und vollständig zweisprachige
Ausgaben für deutsch- und englischsprachige Leser sowie für Sprachlernende.
Grundlage ist die mitgelieferte Project-Gutenberg-EPUB-Ausgabe.
...
**English:** The `easy-german` edition contains the complete novel, not an
abridged retelling. It is intended for readers who find long sentence
structures and rare vocabulary difficult. Long sentences are divided inside
their original paragraphs, wording is modern and concrete, and every event,
conversation, letter, narrative judgment, and ironic turn remains present.
The edition aims broadly at accessible B1-level prose; it does not claim the
formally regulated standard known as German *Leichte Sprache*.
Chapter headings use familiar Arabic numbers in the finished book.

An introductory “Important things to know before reading” section explains
women’s limited economic choices, inheritance, social rank, visits, balls,
annual incomes, church patronage, the militia, and Austen’s irony. Short
footnotes explain selected terms at their first occurrence—for example why
Netherfield Park is a country house and private estate rather than a public
park. The same terminology registry guides every chapter translation and
generates the more detailed reader glossary at the end of the book.

**Deutsch:** Die Ausgabe `easy-german` enthält den vollständigen Roman und
keine gekürzte Nacherzählung. Sie richtet sich an Menschen, denen lange
Satzstrukturen und seltene Wörter das Lesen erschweren. Lange Sätze werden
innerhalb ihrer ursprünglichen Absätze geteilt. Die Sprache ist modern und
konkret. Jede Handlung, jedes Gespräch, jeder Brief, jede erzählerische
Wertung und jede ironische Wendung bleibt erhalten. Die Ausgabe orientiert
sich an gut zugänglicher Sprache etwa auf B1-Niveau. Sie erhebt keinen Anspruch
auf die formal geregelte *Leichte Sprache*.
Die Kapitelüberschriften verwenden im fertigen Buch vertraute arabische Zahlen.

Der einleitende Abschnitt »Wichtig vor dem Lesen« erklärt die eingeschränkten
wirtschaftlichen Möglichkeiten von Frauen, Erbrecht, gesellschaftlichen Rang,
Besuche, Bälle, Jahreseinkommen, kirchliche Förderung, die Miliz und Austens
Ironie. Kurze Fußnoten erläutern ausgewählte Begriffe beim ersten Vorkommen.
So wird bei Netherfield Park erklärt, dass es sich um ein Landhaus mit privatem
...
## Easy English / Einfaches Englisch

**English:** The `easy-english` edition contains the complete novel, not an
abridged retelling. It is adapted directly from the original English chapters
for readers who find Austen's long sentences, rare vocabulary, and unstated
historical rules difficult. Every source paragraph remains one Easy English
paragraph. Long sentences are divided inside that paragraph, while every
event, conversation, letter, judgment, and ironic turn remains present. The
edition aims broadly at accessible B1 English and does not claim a formally
regulated Easy Read standard. Finished chapter headings use familiar Arabic
numbers.

The adaptation is governed by a shared 39-entry terminology and character
glossary. Short notes explain selected historical terms at their first use,
and the same registry generates the reader glossary at the end of the book.
Its accessible introduction explains the entail, marriage and money, social
rank, formal visits, the length and meaning of dances, church patronage, the
militia, and Austen's irony.

**Deutsch:** Die Ausgabe `easy-english` enthält den vollständigen Roman und
keine gekürzte Nacherzählung. Sie wird direkt aus den englischen
Originalkapiteln für Menschen bearbeitet, denen Austens lange Sätze, seltene
Wörter und unausgesprochene historische Regeln das Lesen erschweren. Jeder
Originalabsatz bleibt genau ein Absatz in Einfachem Englisch. Lange Sätze
werden innerhalb dieses Absatzes geteilt; jede Handlung, jedes Gespräch,
jeder Brief, jede Wertung und jede ironische Wendung bleibt erhalten. Die
Ausgabe orientiert sich an zugänglichem Englisch etwa auf B1-Niveau, ohne
einen formal geregelten *Easy Read*-Standard zu beanspruchen. Im fertigen Buch
stehen vertraute arabische Kapitelnummern.

Ein gemeinsames Glossar mit 39 verbindlichen Begriffen und Figurenstimmen
leitet die Bearbeitung. Kurze Anmerkungen erklären ausgewählte historische
Begriffe beim ersten Vorkommen; dasselbe Register erzeugt das Leseglossar am
Buchende. Die zugängliche Einführung erklärt Erbbindung, Ehe und Geld,
gesellschaftlichen Rang, formelle Besuche, Länge und Bedeutung der Tänze,
kirchliche Patronage, die Miliz und Austens Ironie.
...
**English:** Replace `all` with `german`, `easy-german`, `easy-english`,
`english`, `german-english`, or `english-german` to build a single edition. `bilingual`
remains an alias for `german-english`. The bilingual editions are generated
automatically from the paragraph-aligned English and German chapters, keeping
both texts synchronized when corrections are made.

**Deutsch:** Statt `all` kann mit `german`, `easy-german`, `easy-english`,
`english`, `german-english` oder `english-german` eine einzelne Ausgabe gebaut werden.
`bilingual` bleibt als Kurzform für `german-english` erhalten. Die
zweisprachigen Fassungen werden automatisch aus den absatzgleichen englischen
...
**Deutsch:** Die Prüfung kontrolliert beide deutschen Übersetzungen,
...
werden, wenn jedes geänderte Paar geprüft wurde:

```sh
python3 tools/verify_translation.py --update-alignment-manifest
python3 tools/verify_translation.py --update-easy-alignment-manifest
python3 tools/verify_translation.py --update-easy-english-alignment-manifest
```
...
The two German-only editions and the Easy English edition include chapter
headings, scene illustrations, ending vignettes, and decorative chapter
initials from the illustrated source.
The historical frontispiece “Reading Jane’s Letters. Chap 34.” appears as a
scene illustration after the first paragraph of Chapter XXXIV. English text
drawn inside a historical illustration remains unchanged. The Easy English
edition uses the English captions; the German editions use translated German
captions.
...
Die beiden rein deutschen Ausgaben und die Ausgabe in Einfachem Englisch
übernehmen Kapitelköpfe, Szenenbilder, Schlussvignetten und dekorative
Kapitelinitialen der illustrierten Quelle. Das
historische Frontispiz »Reading Jane’s Letters. Chap 34.« erscheint als
Szenenbild nach dem ersten Absatz von Kapitel XXXIV. Englischer Text innerhalb
einer historischen Zeichnung bleibt unverändert. Die Ausgabe in Einfachem
Englisch verwendet die englischen Bildunterschriften; die deutschen Ausgaben
verwenden übersetzte deutsche Bildunterschriften.
...
**English:** Publishing a GitHub release builds the modern German, Easy German,
Easy English, and both bilingual editions. Each is attached with its cover, in
three book formats, and as a ZIP archive:

**Deutsch:** Beim Veröffentlichen eines GitHub-Releases werden die moderne
deutsche, die einfache deutsche, die einfache englische und beide
zweisprachigen Fassungen gebaut. Jede wird mit ihrem Umschlag, in drei
Buchformaten und als ZIP-Archiv angehängt:

- `Stolz-und-Vorurteil-modernes-Deutsch-cover.png`
...
- `Stolz-und-Vorurteil-Einfaches-Deutsch-cover.png`
- `Stolz-und-Vorurteil-Einfaches-Deutsch.epub`
- `Stolz-und-Vorurteil-Einfaches-Deutsch.html`
- `Stolz-und-Vorurteil-Einfaches-Deutsch.pdf`
- `Stolz-und-Vorurteil-Einfaches-Deutsch.zip`
- `Pride-and-Prejudice-Easy-English-cover.png`
- `Pride-and-Prejudice-Easy-English.epub`
- `Pride-and-Prejudice-Easy-English.html`
- `Pride-and-Prejudice-Easy-English.pdf`
- `Pride-and-Prejudice-Easy-English.zip`
- `Stolz-und-Vorurteil-Deutsch-Englisch-cover.png`
...
- `Pride-and-Prejudice-English-German-cover.png`
- `Pride-and-Prejudice-English-German.epub`
- `Pride-and-Prejudice-English-German.html`
- `Pride-and-Prejudice-English-German.pdf`
- `Pride-and-Prejudice-English-German.zip`
...
**English:** Gitea Actions builds and publishes the same 25 release assets. The
...
**Deutsch:** Gitea Actions baut und veröffentlicht dieselben 25 Release-Dateien.
